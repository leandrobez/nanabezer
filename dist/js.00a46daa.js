...
var init = function init() {
  //dom
  var hamburger = document.querySelector('.il-menu--hamburger');
  var painel = document.querySelector('.il-painel');
  ...
  var navegation = document.querySelector('.il-navegation ul');
  ...
  var managerNav = function managerNav() {
    navegation.childNodes[1].addEventListener('click', function () {
      if (page !== '#section1') {
        window.location.hash = '#section1';
      }
    });
    navegation.childNodes[3].addEventListener('click', function () {
      if (page !== '#section2') {
        window.location.hash = '#section2';
      }
    });
    navegation.childNodes[5].addEventListener('click', function () {
      if (page !== '#section3') {
